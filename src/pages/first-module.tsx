        ...
        <Layout>
          ...
          <Container maxWidth='xl' sx={{paddingTop: '70px'}}>
              ...
              <Typography variant="body1">
                  Предполагается, что дом купца Лёхова станет сердцем проекта Арт-Резиденции, его постоянным домом. А это значит что пространство должно отвечать многим требованиям проекта, стать универсальным для различного рода творческих мероприятий и уметь адаптироваться под текущие сценарии и задумки своих резидентов.
              </Typography>
              <Typography variant="body1">
              Именно поэтому за основу концепции взята идея модульности, как главного инструмента трансформируемого пространства.
              </Typography>
              <StaticImage
